<table class="container table-bordered table shadow border-0 rounded-lg">
    ...
    <tbody>
        @forelse ($specialites as $id => $specialite)
        <tr>
            <td>{{ $id + 1 }}</td>
            ...
            <td class="d-flex justify-content-between">
                ...
                <span class="d-flex align-items-end w-auto">
                    <button class="btn btn-secondary shadow border-2 rounded-lg" wire:click="modifier({{$specialite->id}})">
                    ...
                    <button class="btn-danger mx-4" wire:click="effacer({{$specialite->id}})">
