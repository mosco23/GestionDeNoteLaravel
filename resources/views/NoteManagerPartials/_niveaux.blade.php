        ...
        <tr>
            ...
            <td class="d-flex justify-content-between">
                ...
                <span class="d-flex align-items-end w-auto">
                    <button class="btn btn-secondary shadow border-2 rounded-lg" wire:click="modifier({{$niveau->id}})">
                    ...
                    <button class="btn-danger mx-4" wire:click="effacer({{$niveau->id}})">
